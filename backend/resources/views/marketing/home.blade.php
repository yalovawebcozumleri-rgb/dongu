...
<section class="site-section site-two-worlds"><div class="site-shell site-two-worlds-grid">
    ...
    <article class="site-world-card site-world-secondary"><span class="site-eyebrow site-eyebrow-light">GÜVENLİ TESLİMAT</span><h2>Süreç iki taraf için de açık.</h2><p>Rezervasyon, teslimat kodu ve değerlendirme adımlarıyla işlemini güvenle tamamla.</p><a class="site-button site-button-lime" href="{{ route('marketing.how-it-works') }}">Nasıl çalışır? <span>↗</span></a></article>
</div></section>
