...
@section('content')
<section class="site-page-hero"><div class="site-shell site-page-hero-inner"><span class="site-kicker"><i></i> İLETİŞİM</span><h1>Bir sorun varsa,<br>buradayız.</h1><p>Kullanıcı desteği, Döngü Destekçisi başvuruları, gizlilik talepleri veya iş birliği fikirleri için doğru kanaldan bize ulaşın.</p></div></section>
...
<article class="site-contact-card"><small>İŞLETME BAŞVURULARI</small><h3>WhatsApp</h3><p>Döngü Destekçisi olmak, bölge ve görünürlük seçeneklerini konuşmak için doğrudan ulaşın.</p><a href="https://wa.me/905413342219?text=Merhaba%2C%20D%C3%B6ng%C3%BC%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum." target="_blank" rel="noopener">+90 541 334 22 19 →</a></article>
