...
<head>
    ...
    <title>{{ $document['title'] }} · DOA</title>
    <style>
...
<main class="page"><article class="hero">
    ...
    <aside class="contact">Soruların için <a href="mailto:{{ $document['operator']['email'] }}">{{ $document['operator']['email'] }}</a> adresinden bize ulaşabilirsin.</aside>
