...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $now = now();
        $nativeSources = json_encode(['direct', 'admob', 'house']);
        $rows = [
        ...
        DB::table('advertisement_placement_settings')->insert([
            ['key' => 'supporters_list', 'label' => 'Döngü Destekçileri listesi', 'kind' => 'house', 'location_label' => 'Yalnızca Döngü reklamı', 'enabled' => true, 'locked' => true, 'source_order' => json_encode(['house']), 'first_after' => 0, 'repeat_every' => 0, 'max_per_session' => 1, 'min_items' => 0, 'admob_android_unit_id' => null, 'admob_ios_unit_id' => null, 'settings' => null, 'created_at' => $now, 'updated_at' => $now],
            ['key' => 'supporter_profile', 'label' => 'Destekçi işletme profili', 'kind' => 'house', 'location_label' => 'Yalnızca Döngü reklamı', 'enabled' => true, 'locked' => true, 'source_order' => json_encode(['house']), 'first_after' => 0, 'repeat_every' => 0, 'max_per_session' => 1, 'min_items' => 0, 'admob_android_unit_id' => null, 'admob_ios_unit_id' => null, 'settings' => null, 'created_at' => $now, 'updated_at' => $now],
