...
const local = StyleSheet.create({ card: { width: '100%', minHeight: 170, padding: 16, borderRadius: 24, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DFE6E0' }, labelRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 9, paddingRight: 28 }, label: { minWidth: 15, minHeight: 15, fontSize: 10, lineHeight: 15, fontWeight: '900', color: '#647168', borderWidth: 1, borderColor: '#B9C4BB', borderRadius: 4, paddingHorizontal: 5, paddingVertical: 1 }, advertiser: { flexShrink: 1, marginLeft: 10, fontSize: 11, lineHeight: 16, fontWeight: '700', color: '#647168' }, main: { flexDirection: 'row', gap: 11 }, icon: { width: 48, height: 48, borderRadius: 12 }, copy: { flex: 1 }, headline: { color: '#172019', fontSize: 16, lineHeight: 21, fontWeight: '900' }, body: { color: '#667169', fontSize: 13, lineHeight: 18, marginTop: 4 }, media: { height: 120, marginTop: 12, borderRadius: 15, overflow: 'hidden' }, button: { alignSelf: 'flex-end', marginTop: 12, borderRadius: 12, overflow: 'hidden', backgroundColor: '#147A49', paddingHorizontal: 18, paddingVertical: 10, color: '#FFFFFF', fontSize: 13, lineHeight: 18, fontWeight: '900' } });
